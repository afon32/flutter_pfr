...
class FutureOneOrderPage extends StatelessWidget{

  const FutureOneOrderPage({super.key});

  @override
  Widget build(BuildContext context){
    return GetBuilder<FutureOneOrderPageController>(
      init: FutureOneOrderPageController(),
      initState: (_) {},
      builder: (_){
        _.loadData(context);
        print('mexanik:');
