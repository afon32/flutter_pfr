...
class AdminHistoryOrderPage extends StatelessWidget{
  const AdminHistoryOrderPage({super.key});

  @override
  Widget build(BuildContext context){
    return GetBuilder<AdminHistoryOrderPageController>(
      init: AdminHistoryOrderPageController(),
      initState: (_) {},
      builder: (_){
        return Scaffold(
          ...
          body: Form(
            key: _.adminHistoryOrderPageKey,
