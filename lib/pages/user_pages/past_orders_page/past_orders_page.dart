...
import 'package:fp/pages/user_pages/past_orders_page/past_orders_page_controller.dart';
...
class PastOrdersPage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return GetBuilder<PastOrdersPageController>(
      init: PastOrdersPageController(),
      initState: (_) {},
      builder: (_){
        return Scaffold(
