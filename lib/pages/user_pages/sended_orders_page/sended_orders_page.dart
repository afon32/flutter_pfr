...
class SendedOrdersPage extends StatelessWidget{
  const SendedOrdersPage({super.key});

  @override
  Widget build(BuildContext context){
    return GetBuilder<SendedOrdersPageController>(
      init: SendedOrdersPageController(),
      initState: (_) {},
      builder: (_){
        return Scaffold(
