...
class AdminHistoryOrderPageController extends GetxController{
  final adminHistoryOrderPageKey = GlobalKey<FormState>();
  final fontSize = 20.0;
  ...
  Stream<List<Orrder>> readOrders() =>
    ...
    if(order.checkFlag && order.dateOfService.toDate().isBefore(DateTime.now())){
    return ListTile(
    ...
    Navigator.pushReplacement(
      adminHistoryOrderPageKey.currentContext!,
      MaterialPageRoute(
