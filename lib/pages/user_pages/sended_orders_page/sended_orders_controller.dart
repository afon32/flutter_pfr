...
class SendedOrdersPageController extends GetxController{
  final sendedOrdersPageKey = GlobalKey<FormState>();
  final fontSize = 20.0;
  ...
  Stream<List<Orrder>> readOrders() =>
    ...
    if(!order.checkFlag && order.username == FirebaseAuth.instance.currentUser!.email){
    return ListTile(
    ...
    Navigator.pushReplacement(
      sendedOrdersPageKey.currentContext!,
      MaterialPageRoute(
        builder: (context) => const OneSendedOrderPage(),
