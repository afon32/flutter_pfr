...
import 'package:fp/pages/admin_pages/admin_order_page/admin_one_order/admin_one_order_page_controller.dart';
import 'package:get/get.dart';

class AdminOneOrderPage extends StatelessWidget{

  const AdminOneOrderPage({super.key});

  @override
  Widget build(BuildContext context){
    return GetBuilder<AdminOneOrderPageController>(
      init: AdminOneOrderPageController(),
      initState: (_) {},
      builder: (_){
        _.loadData(context);
        return Scaffold(
                    ...
                    child: SizedBox(
                            ...
                            child: FractionallySizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ButtonStyle(alignment: Alignment.center, minimumSize: MaterialStateProperty.all(const Size(150, 50))), 
                                child: const Text('Далее', style: TextStyle(fontSize: 25),),
                              )
                            )
                          ),)
                  ]
