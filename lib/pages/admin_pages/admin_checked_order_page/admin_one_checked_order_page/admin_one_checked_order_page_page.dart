...
class AdminOneCheckedOrderPage extends StatelessWidget{

  const AdminOneCheckedOrderPage({super.key});

  @override
  Widget build(BuildContext context){
    return GetBuilder<AdminOneCheckedOrderPageController>(
      init: AdminOneCheckedOrderPageController(),
      initState: (_) {},
      builder: (_){
        _.loadData(context);
        print('mexanik:');
        ...
        return Scaffold(
          ...
          child: FutureBuilder(future: _.readGarageName(), builder: (context, snapshot)
            ...
            child: Container(
              ...
              child: Center(
                child: Form(
                  key: _.adminOneCheckedOrderPageKey,
          ...
          MaterialPageRoute(builder: (context) => const AdminPage(),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: MediaQuery.of(context).size.width * 0.4,
                          child: const AutoSizeText('Ожидаемая стоимость:', style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold,), maxLines: 1,),
                        ),]),
