...
class FutureOrdersPageController extends GetxController{
  final futureOrdersPageKey = GlobalKey<FormState>();
  final fontSize = 20.0;
  ...
  Stream<List<Orrder>> readOrders() =>
    ...
    if(order.checkFlag && order.username == FirebaseAuth.instance.currentUser!.email && order.dateOfService.toDate().isAfter(DateTime.now())){
    return ListTile(
    ...
    Navigator.pushReplacement(
      futureOrdersPageKey.currentContext!,
      MaterialPageRoute(
